...
export const TrendingTitleStatsContainer = styled.div`
  dispaly: flex;
...
export const TrendingViewsPublishStats = styled.div`
  display: flex;
  align-items: center;
  margin-top: 4px;
  @media screen and (min-width: 576px) {
...
export const TrendingDot = styled.div`
  width: 5px;
  height: 5px;
  border-radius: 50%;
...
export const TrendingViewsCount = styled.span`
  font-size: 20px;
  color: #606060;
  margin-left: 18px;
  font-family: 'Roboto';
...
export const TrendingPublishDot = styled.div`
  width: 5px;
  height: 5px;
  border-radius: 50%;
  background-color: ${props =>
